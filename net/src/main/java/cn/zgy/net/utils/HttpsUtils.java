...
public class HttpsUtils {
    private static final String ERR = "HTTPS_ERR";
     ...
     * certificates用含有服务端公钥的证书校验服务端证书
     */
    ...
    /**
     * https双向认证
     * bksFile 和 password客户端使用bks证书校验服务端证书
     * X509TrustManager如果需要自己校验，那么可以自己实现相关校验，如果不需要自己校验，那么传null即可
     */
